...
dir1 = '/data/pku/home/pengj/testvbs/workdir/ana2018/step8_fiducial/calculate_uncer/step6_uncertainty'
name = sys.argv[1]
...
for i in range(0, len(lines)):
    ...
    outfile.write('cp -r ' + dir1 + '/make_hist_bkg_control2 .'+'\n')
    outfile.write('cp -r ' + dir1 + '/make_hist_control2 .'+'\n')
    outfile.write('cp -r ' + dir1 + '/make_hist_bkg .'+'\n')
    outfile.write('cp -r ' + dir1 + '/make_hist .'+'\n')
    outfile.write('cp -r ' + dir1 + '/filelist_dir2 .'+'\n')
    outfile.write(x[0]+'\n')
    outfile.write('cp -r $1 ' + dir1 + '/condor_dir'+'\n')
