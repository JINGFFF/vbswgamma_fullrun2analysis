...
for i in range(0, len(lines)):
    ...
    outfile.write('cd ../..'+'\n')
    outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2016/step2_fake_photon/scalef .'+'\n')
    ...
    outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2016/step2_fake_photon/make_hist2 .'+'\n')
    outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2016/step2_fake_photon/filelist_dir2 .'+'\n')
    outfile.write(x[0]+'\n')
    outfile.write('cp -r $1 /data/pku/home/pengj/testvbs/workdir/ana2016/step2_fake_photon/condor_dir'+'\n')
