...
./make_hist filelist_dir/tight_for_fakephoton_lepton.txt $1 2018 data all data_fake data_lepton medium 7 10
cp -r $1 /data/pku/home/pengj/testvbs/analysis/analysis2018/step2_fake_photon/fp_out
