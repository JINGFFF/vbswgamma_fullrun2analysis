...
./make_hist filelist_dir/tight_for_fakephoton_WGJets.txt $1 2018 mc all true WGJets medium 4 10
...
./make_hist filelist_dir/tight_for_fakephoton_WJets_0j.txt $1 2018 mc all real_fake W0Jets medium 4 10
