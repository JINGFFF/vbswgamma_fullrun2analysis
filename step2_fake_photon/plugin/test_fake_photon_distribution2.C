...
*/
      ...
      if(m_template_type == "data"){
         ...
         if(*drla>0.5 && *drj1l_new>0.5 && *drj2l_new>0.5 && *drj1a_new>0.5 && *drj2a_new>0.5 && *photonhaspixelseed==0 && *jet1pt_new>40 &&fabs(*jet1eta_new)<4.7 && *jet2pt_new>30 &&fabs(*jet2eta_new)<4.7 ){
      ...
      if(m_template_type == "data_fake"){
         ...
         if(*drla_f>0.5 && *drj1l_new_f>0.5 && *drj2l_new_f>0.5 && *drj1a_new_f>0.5 && *drj2a_new_f>0.5 && *photonhaspixelseed_f==0 && *jet1pt_new_f>40 &&fabs(*jet1eta_new_f)<4.7 && *jet2pt_new_f>30 &&fabs(*jet2eta_new_f)<4.7){
