...
Double_t mjj_bins[8]={500, 600, 800, 1000, 1200, 1500, 1800, 2000};
...
TString uncertainty_jecr[5] = { "new", "JEC_up", "JEC_down", "JER_up", "JER_down"};
TH1D * h[19];
TH1D * h_jecr[5];
...
*/
         if(fill_Mjj>500&&fill_Mjj<600)hist->Fill(0.5,weight);//0~1, 2.5~4.5 and 500~800
         if(fill_Mjj>=600&&fill_Mjj<800)hist->Fill(1.5,weight);//1~2 2.5~4.5 and 800~1200
         if(fill_Mjj>=800&&fill_Mjj<1000)hist->Fill(2.5,weight);//2~3 2.5~4.5 1200~2000
         if(fill_Mjj>=1000&&fill_Mjj<1200)hist->Fill(3.5,weight);//7~8 6~infi800~1200
         if(fill_Mjj>=1200&&fill_Mjj<1500)hist->Fill(4.5,weight);//8~9 6~infi 800~1200
         if(fill_Mjj>=1500&&fill_Mjj<1800)hist->Fill(5.5,weight);//8~9 6~infi 800~1200
         if(fill_Mjj>=1800)hist->Fill(6.5,weight);//8~9 6~infi 800~1200


}

void test::pass_cut(){
   if(m_channel == "muon" && fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1) return false;
...
photonp42.Delete();
      ...
      muon_cut_signal_region_jec_up = fill_HLT_muon==1
                 ...
                 && fill_Dphiwajj_JEC_up >2.0
                 && fill_zepp_JEC_up < 1.2
...
//if(muon_cut_signal_region_jec_up ==1) nm2 = nm2 + 1;
      muon_cut_signal_region_jec_down = fill_HLT_muon==1
                 ...
                 && fill_Dphiwajj_JEC_down >2.0
                 && fill_zepp_JEC_down < 1.2
      ...
      muon_cut_signal_region_jer_up = fill_HLT_muon==1
                 ...
                 && fill_Dphiwajj_JER_up > 2.0
                 && fill_zepp_JER_up < 1.2
      ...
      muon_cut_signal_region_jer_down = fill_HLT_muon==1
                 ...
                 && fill_Dphiwajj_JER_down >2.0
                 && fill_zepp_JER_down < 1.2
...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < pho_eta_high && fabs(fill_photonsceta) > pho_eta_low){
         ...
         if(m_type == "data") {
            ...
            weight = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_L1_up = (*prefWeightUp) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_L1_down = (*prefWeightDown) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_photon_ID_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_up_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_photon_ID_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_low_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_electron_ID_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_up_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_ID_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_low_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_electron_Reco_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_up_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_Reco_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_low_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_electron_HLT_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_up_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_HLT_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_low_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;


            weight_muon_ID_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_up_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_muon_ID_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_low_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_muon_iso_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_up_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_muon_iso_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_low_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;

            weight_muon_HLT_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_up_SF * btag_jet1_SF * btag_jet2_SF;
            weight_muon_HLT_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_low_SF * btag_jet1_SF * btag_jet2_SF;

            weight_jec_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF_JEC_up * btag_jet2_SF_JEC_up;
            weight_jec_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF_JEC_down * btag_jet2_SF_JEC_down;
            weight_jer_up = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF_JER_up * btag_jet2_SF_JER_up;
            weight_jer_down = (*prefWeight) * cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF_JER_down * btag_jet2_SF_JER_down;
            ...
            double fill_weight_jecr[5] = { weight, weight_jec_up, weight_jec_down, weight_jer_up, weight_jer_down};
            if(cut1){ 
               fill_hist(fill_Mjj, fill_deltaeta, h_jecr[0], fill_weight_jecr[0]);

            }
            if (cut2) {
               fill_hist(fill_Mjj_JEC_up, fill_deltaeta_JEC_up, h_jecr[1], fill_weight_jecr[1]);

            }
            if (cut3) {
               fill_hist(fill_Mjj_JEC_down, fill_deltaeta_JEC_down, h_jecr[2], fill_weight_jecr[2]);

            }
            if (cut4) {
               fill_hist(fill_Mjj_JER_up, fill_deltaeta_JER_up, h_jecr[3], fill_weight_jecr[3]);

            }
            if (cut5) {
               fill_hist(fill_Mjj_JER_down, fill_deltaeta_JER_down, h_jecr[4], fill_weight_jecr[4]);
