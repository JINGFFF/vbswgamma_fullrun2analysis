...
for i in range(0, len(lines)):
    ...
    outfile.write('cd ../..'+'\n')
    outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2018/step4_aqgc/calculate_uncer/step6_uncertainty/scalef .'+'\n')
    #outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2018/step8_fiducial/calculate_uncer/step6_uncertainty/make_hist_bkg .'+'\n')
    outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2018/step4_aqgc/calculate_uncer/step6_uncertainty/make_hist .'+'\n')
    outfile.write('cp -r /data/pku/home/pengj/testvbs/workdir/ana2018/step4_aqgc/calculate_uncer/step6_uncertainty/filelist_dir2 .'+'\n')
    outfile.write(x[0]+'\n')
    outfile.write('cp -r $1 /data/pku/home/pengj/testvbs/workdir/ana2018/step4_aqgc/calculate_uncer/step6_uncertainty/condor_dir'+'\n')
