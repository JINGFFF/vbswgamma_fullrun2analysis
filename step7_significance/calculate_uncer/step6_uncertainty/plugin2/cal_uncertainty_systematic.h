...
TH1D * get_systematic_jecr_1D(TString which_region, TString outdir, TString which_type, TString which_sample, TString uncertainty_hist_name, TString infilename, TString var_name, double lumi ){
cout<<"ok0"<<endl;
   TFile*input = new TFile (infilename);
cout<<"ok0"<<endl;
   TH1D * h_center   = (TH1D*)input->Get("hist_");
   TH1D * h_up       = (TH1D*)input->Get("hist_"+uncertainty_hist_name+"_up");
   TH1D * h_down     = (TH1D*)input->Get("hist_"+uncertainty_hist_name+"_down");
   h_center->Scale(lumi);
cout<<"ok1"<<endl;
h_center->Print("all");
cout<<"ok1"<<endl;
...
cout<<tmp_h_down->GetMinimum()-0.1<<" "<<tmp_h_up->GetMaximum()+0.05<<endl;
	...
	fPads2->Update();
   c1->SaveAs(outdir+"/graph/"+ which_type + "_" +which_sample+"_"+which_region+"_"+uncertainty_hist_name+".png");
...
TH1D * get_systematic_uncertainty_1D(TString which_region, TString outdir, TString which_type, TString which_sample, TString uncertainty_hist_name, TString infilename, TString var_name, double lumi){
...
TH1D * get_systematic_jecr_2D(TString which_region, TString outdir, TString which_sample, TString uncertainty_hist_name, TString infilename, TString var_name, double lumi ){
   TFile*input = new TFile (infilename);
   TH2D * h_center   = (TH2D*)input->Get("hist_");
   TH2D * h_up       = (TH2D*)input->Get("hist_"+uncertainty_hist_name+"_up");
   TH2D * h_down     = (TH2D*)input->Get("hist_"+uncertainty_hist_name+"_down");
