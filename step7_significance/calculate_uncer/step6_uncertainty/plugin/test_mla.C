...
void test::fill_hist(double fill_Mjj, double fill_deltaeta, TH1D* hist, double weight){
         ...
         if(fill_Mjj>=500  &&fill_Mjj<800   &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(4.5,weight);//3~4 4.5~6 500~800 
         if(fill_Mjj>=800  &&fill_Mjj<1200  &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(5.5,weight);//4~5 4.5~6 800~1200
         if(fill_Mjj>=1200 &&fill_Mjj<1700  &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(6.5,weight);//4~5 4.5~6 800~1200
         if(fill_Mjj>=1700                  &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(7.5,weight);//5~6 6~infi 500~800

         if(fill_Mjj>=500  &&fill_Mjj<800   &&fill_deltaeta>=130)                     hist->Fill(8.5,weight);//6~7 6~infi 800~1200
         if(fill_Mjj>=800  &&fill_Mjj<1200  &&fill_deltaeta>=130)                     hist->Fill(9.5,weight);//7~8 6~infi800~1200
         if(fill_Mjj>=1200 &&fill_Mjj<1700  &&fill_deltaeta>=130)                     hist->Fill(10.5,weight);//7~8 6~infi800~1200
         if(fill_Mjj>=1700                  &&fill_deltaeta>=130)                     hist->Fill(11.5,weight);//8~9 6~infi 800~1200
