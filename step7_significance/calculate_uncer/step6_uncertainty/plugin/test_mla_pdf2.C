...
void test::fill_hist(double fill_Mjj, double fill_deltaeta, TH1D* hist, double weight){
         ...
         if(fill_Mjj>500   &&fill_Mjj<800   &&fill_deltaeta>=30  &&fill_deltaeta<80)  hist->Fill(0.5,weight);//0~1, 2.5~4.5 and 500~800
         if(fill_Mjj>=800  &&fill_Mjj<1200  &&fill_deltaeta>=30  &&fill_deltaeta<80)  hist->Fill(1.5,weight);//1~2 2.5~4.5 and 800~1200
         if(fill_Mjj>=1200 &&fill_Mjj<1700  &&fill_deltaeta>=30  &&fill_deltaeta<80)  hist->Fill(2.5,weight);//2~3 2.5~4.5 1200~2000
         if(fill_Mjj>=1700                  &&fill_deltaeta>=30  &&fill_deltaeta<80)  hist->Fill(3.5,weight);//5~6 6~infi 500~800

         if(fill_Mjj>=500  &&fill_Mjj<800   &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(0.5,weight);//3~4 4.5~6 500~800 
         if(fill_Mjj>=800  &&fill_Mjj<1200  &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(1.5,weight);//4~5 4.5~6 800~1200
         if(fill_Mjj>=1200 &&fill_Mjj<1700  &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(2.5,weight);//4~5 4.5~6 800~1200
         if(fill_Mjj>=1700                  &&fill_deltaeta>=80  &&fill_deltaeta<130) hist->Fill(3.5,weight);//5~6 6~infi 500~800

         if(fill_Mjj>=500  &&fill_Mjj<800   &&fill_deltaeta>=130)                     hist->Fill(0.5,weight);//6~7 6~infi 800~1200
         if(fill_Mjj>=800  &&fill_Mjj<1200  &&fill_deltaeta>=130)                     hist->Fill(1.5,weight);//7~8 6~infi800~1200
         if(fill_Mjj>=1200 &&fill_Mjj<1700  &&fill_deltaeta>=130)                     hist->Fill(2.5,weight);//7~8 6~infi800~1200
         if(fill_Mjj>=1700                  &&fill_deltaeta>=130)                     hist->Fill(3.5,weight);//8~9 6~infi 800~1200
...
void test::creat_hist(){
   ...
   for(int j = 0; j<21; j++){
      h[j] = new TH1D("hist_"+uncertainty_hist_name[j],"hist_" +uncertainty_hist_name[j], 4, 0, 4); 
   }
    
   for(int j2 = 0; j2<4; j2++){
      h_jecr[j2] = new TH1D("hist_"+uncertainty_jecr[j2],"hist_"+uncertainty_jecr[j2], 4, 0, 4);   
   }

  
   for(int k2 = 1; k2<401; k2++){
      sprintf(th2name,"%d",k2);
      h_pdf[k2] = new TH1D("hist_pdf_" +var+ th2name,"hist_pdf_" +var+ th2name, 4, 0, 4);
   }
...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < pho_eta_high && fabs(fill_photonsceta) > pho_eta_low){
         ...
         if(m_type == "data") {
            ...
            if(cut1){ 
               for(int k2 = 1; k2<401; k2++){
                  //cout<<pweight[k2-1]<<endl;
                  //tmp_weight = fill_weight[0]*(pweight[k2-1]);
                  fill_hist(fill_Mjj, fill_Mla, h_pdf[k2], fill_weight[0]*(pweight[k2-1]));
                  //h_pdf[k2]->Write();
               }

               for(int j = 0; j<21; j++){
                  fill_hist(fill_Mjj, fill_Mla, h[j], fill_weight[j]);
               }
            }
            if (cut2) {
               fill_hist(fill_Mjj_JEC_up, fill_Mla, h_jecr[0], fill_weight_jecr[0]);

            }
            if (cut3) {
               fill_hist(fill_Mjj_JEC_down, fill_Mla, h_jecr[1], fill_weight_jecr[1]);

            }
            if (cut4) {
               fill_hist(fill_Mjj_JER_up, fill_Mla, h_jecr[2], fill_weight_jecr[2]);

            }
            if (cut5) {
               fill_hist(fill_Mjj_JER_down, fill_Mla, h_jecr[3], fill_weight_jecr[3]);
