...
int neff1 =0, neff2 = 0, neff3 = 0, neff4 = 0, neff5 = 0, neff6 = 0, neff7 = 0, neff8 = 0;
...
if(fill_HLT_muon==1 ) nl1++;
if(fill_HLT_muon==1 && abs(fill_lep)==13) nl2++;
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. ) nl3++;
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 ) nl4++;
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 ) nl5++;
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1) nl6++;
cout<<nl1<<" "<<nl2<<" "<<nl3<<" "<<nl4<<" "<<nl5<<" "<<nl6<<endl;

if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1) neff1++;
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25.) neff2++;

if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25. && fill_jet1pt>40. && fabs(fill_jet1eta)<4.7) neff3++;

if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25. && fill_jet1pt>40. && fabs(fill_jet1eta)<4.7
          && fill_jet2pt>30. && fabs(fill_jet2eta)<4.7) neff4++;

if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25. && fill_jet1pt>40. && fabs(fill_jet1eta)<4.7
          && fill_jet2pt>30. && fabs(fill_jet2eta)<4.7 && fill_MET_et>30.) neff5++;

if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25. && fill_jet1pt>40. && fabs(fill_jet1eta)<4.7
          && fill_jet2pt>30. && fabs(fill_jet2eta)<4.7 && fill_MET_et>30. && fill_mtVlepJECnew>30) neff6++;
...
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25. && fill_jet1pt>40. && fabs(fill_jet1eta)<4.7
          ...
          && fill_jet1deepcsv < btag_cut_value && fill_jet2deepcsv < btag_cut_value) neff7++;
...
if(fill_HLT_muon==1 && abs(fill_lep)==13 && fill_ptlep1>30. && fabs(fill_etalep1)<2.4 && fill_ngoodmus==1 && fill_ngoodeles==0 &&(fill_nloosemus+fill_nlooseeles)==1 && fill_photonhaspixelseed==0 && fill_photonet>25. && fill_jet1pt>40. && fabs(fill_jet1eta)<4.7
          ...
          && fill_Mjj>500. && fill_Mva > 100. && fill_deltaeta > 2.5) neff8++;
//cout<<neff1<<" "<<neff2<<" "<<neff3<<" "<<neff4<<" "<<neff5<<" "<<neff6<<" "<<neff7<<" "<<neff8<<endl;
