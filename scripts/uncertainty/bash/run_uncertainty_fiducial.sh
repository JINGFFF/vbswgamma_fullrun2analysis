...
2_calculate_uncertainty.py $1 $2 $4 $3 signal electron barrel medium mjj fiducialXS off
2_calculate_uncertainty.py $1 $2 $4 $3 signal muon endcap medium mjj fiducialXS off
2_calculate_uncertainty.py $1 $2 $4 $3 signal electron endcap medium mjj fiducialXS off
2_calculate_uncertainty.py $1 $2 $4 $3 control muon barrel medium mjj fiducialXS off
2_calculate_uncertainty.py $1 $2 $4 $3 control electron barrel medium mjj fiducialXS off
2_calculate_uncertainty.py $1 $2 $4 $3 control muon endcap medium mjj fiducialXS off
2_calculate_uncertainty.py $1 $2 $4 $3 control electron endcap medium mjj fiducialXS off
