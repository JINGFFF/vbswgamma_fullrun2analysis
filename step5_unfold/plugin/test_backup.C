...
void test::Loop(TDirectory * dir)
{
   ...
   if(m_sample == "WGJJ" || m_sample == "WGJets") TTreeReaderArray<Double_t>    pweight  = {fReader, "pweight"};
...
//cout<<fill_Mva_JEC_up<<endl;
      ...
      muon_cut_signal_region_jec_up = fill_HLT_muon==1
                 && fill_Mjj_JEC_up>500.
                 && fill_Mva_JEC_up > 100. && fill_Mla > 30.
      ...
      muon_cut_signal_region_jec_down = fill_HLT_muon==1
                 ...
                 && fill_Mva_JEC_down > 100. && fill_Mla > 30.
      ...
      muon_cut_signal_region_jer_up = fill_HLT_muon==1
                 && fill_Mjj_JER_up>500.
                 && fill_Mva_JER_up > 100. && fill_Mla > 30.
      ...
      muon_cut_signal_region_jer_down = fill_HLT_muon==1
                 ...
                 && fill_Mva_JER_down > 100. && fill_Mla > 30.
      ...
      electron_cut_aqgc_region = fill_HLT_electron==0 && abs(fill_lep)==11 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
      ...
      electron_cut_aqgc_region_jec_up = fill_HLT_electron==0 && abs(fill_lep)==11 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
       ...
       electron_cut_aqgc_region_jec_down = fill_HLT_electron==0 && abs(fill_lep)==11 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
      ...
      electron_cut_aqgc_region_jer_up = fill_HLT_electron==0 && abs(fill_lep)==11 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
       ...
       electron_cut_aqgc_region_jer_down = fill_HLT_electron==0 && abs(fill_lep)==11 && fill_ngoodmus==0 && fill_ngoodeles==1 &&(fill_nloosemus+fill_nlooseeles)==1
...
//cout<<"pass"<<endl;
      ...
      if(m_type == "mc") {
         ...
         // jet1 : jec_up
         if(fabs(fill_jet1eta_JEC_up)<2.5){
            if(fabs(fill_jet1pf_JEC_up)==5){
               if(fill_jet1deepcsv_JEC_up>btag_cut_value){
                  btag_jet1_SF_JEC_up     = b_scale("central",m_btag_workpoint,fill_jet1pt_JEC_up);
                  btag_jet1_up_SF_JEC_up  = b_scale("up",m_btag_workpoint,fill_jet1pt_JEC_up);
                  btag_jet1_low_SF_JEC_up = b_scale("low",m_btag_workpoint,fill_jet1pt_JEC_up);
               }
               if(fill_jet1deepcsv_JEC_up<btag_cut_value){
                  btag_jet1_SF_JEC_up     = (1-beff(m_btag_workpoint,fill_jet1pt_JEC_up)*b_scale("central",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-beff(m_btag_workpoint,fill_jet1pt_JEC_up));
                  btag_jet1_up_SF_JEC_up  = (1-beff(m_btag_workpoint,fill_jet1pt_JEC_up)*b_scale("up",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-beff(m_btag_workpoint,fill_jet1pt_JEC_up));
                  btag_jet1_low_SF_JEC_up = (1-beff(m_btag_workpoint,fill_jet1pt_JEC_up)*b_scale("low",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-beff(m_btag_workpoint,fill_jet1pt_JEC_up));
               }
            }

            if(fabs(fill_jet1pf_JEC_up)==4){
               if(fill_jet1deepcsv_JEC_up>btag_cut_value){
                  btag_jet1_SF_JEC_up     = c_scale("central",m_btag_workpoint,fill_jet1pt_JEC_up);
                  btag_jet1_up_SF_JEC_up  = c_scale("up",m_btag_workpoint,fill_jet1pt_JEC_up);
                  btag_jet1_low_SF_JEC_up = c_scale("low",m_btag_workpoint,fill_jet1pt_JEC_up);
               }
               if(fill_jet1deepcsv_JEC_up<btag_cut_value){
                  btag_jet1_SF_JEC_up     = (1-ceff(m_btag_workpoint,fill_jet1pt_JEC_up)*c_scale("central",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-ceff(m_btag_workpoint,fill_jet1pt_JEC_up));
                  btag_jet1_up_SF_JEC_up  = (1-ceff(m_btag_workpoint,fill_jet1pt_JEC_up)*c_scale("up",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-ceff(m_btag_workpoint,fill_jet1pt_JEC_up));
                  btag_jet1_low_SF_JEC_up = (1-ceff(m_btag_workpoint,fill_jet1pt_JEC_up)*c_scale("low",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-ceff(m_btag_workpoint,fill_jet1pt_JEC_up));
               }
            }

            if(fabs(fill_jet1pf_JEC_up)!=4 && fabs(fill_jet1pf_JEC_up)!=5){
               if(fill_jet1deepcsv_JEC_up>btag_cut_value){
                  btag_jet1_SF_JEC_up     = l_scale("central",m_btag_workpoint,fill_jet1pt_JEC_up);
                  btag_jet1_up_SF_JEC_up  = l_scale("up",m_btag_workpoint,fill_jet1pt_JEC_up);
                  btag_jet1_low_SF_JEC_up = l_scale("low",m_btag_workpoint,fill_jet1pt_JEC_up);
               }
               if(fill_jet1deepcsv_JEC_up<btag_cut_value){
                  btag_jet1_SF_JEC_up     = (1-leff(m_btag_workpoint,fill_jet1pt_JEC_up)*l_scale("central",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-leff(m_btag_workpoint,fill_jet1pt_JEC_up));
                  btag_jet1_up_SF_JEC_up  = (1-leff(m_btag_workpoint,fill_jet1pt_JEC_up)*l_scale("up",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-leff(m_btag_workpoint,fill_jet1pt_JEC_up));
                  btag_jet1_low_SF_JEC_up = (1-leff(m_btag_workpoint,fill_jet1pt_JEC_up)*l_scale("low",m_btag_workpoint,fill_jet1pt_JEC_up))/(1-leff(m_btag_workpoint,fill_jet1pt_JEC_up));
               }
            }
         }

         else{
            btag_jet1_SF_JEC_up     = 1;
            btag_jet1_up_SF_JEC_up  = 1;
            btag_jet1_low_SF_JEC_up = 1;
         }

         // jet1 : jec_down
         if(fabs(fill_jet1eta_JEC_down)<2.5){
            if(fabs(fill_jet1pf_JEC_down)==5){
               if(fill_jet1deepcsv_JEC_down>btag_cut_value){
                  btag_jet1_SF_JEC_down     = b_scale("central",m_btag_workpoint,fill_jet1pt_JEC_down);
                  btag_jet1_up_SF_JEC_down  = b_scale("up",m_btag_workpoint,fill_jet1pt_JEC_down);
                  btag_jet1_low_SF_JEC_down = b_scale("low",m_btag_workpoint,fill_jet1pt_JEC_down);
               }
               if(fill_jet1deepcsv_JEC_down<btag_cut_value){
                  btag_jet1_SF_JEC_down     = (1-beff(m_btag_workpoint,fill_jet1pt_JEC_down)*b_scale("central",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-beff(m_btag_workpoint,fill_jet1pt_JEC_down));
                  btag_jet1_up_SF_JEC_down  = (1-beff(m_btag_workpoint,fill_jet1pt_JEC_down)*b_scale("up",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-beff(m_btag_workpoint,fill_jet1pt_JEC_down));
                  btag_jet1_low_SF_JEC_down = (1-beff(m_btag_workpoint,fill_jet1pt_JEC_down)*b_scale("low",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-beff(m_btag_workpoint,fill_jet1pt_JEC_down));
               }
            }

            if(fabs(fill_jet1pf_JEC_down)==4){
               if(fill_jet1deepcsv_JEC_down>btag_cut_value){
                  btag_jet1_SF_JEC_down     = c_scale("central",m_btag_workpoint,fill_jet1pt_JEC_down);
                  btag_jet1_up_SF_JEC_down  = c_scale("up",m_btag_workpoint,fill_jet1pt_JEC_down);
                  btag_jet1_low_SF_JEC_down = c_scale("low",m_btag_workpoint,fill_jet1pt_JEC_down);
               }
               if(fill_jet1deepcsv_JEC_down<btag_cut_value){
                  btag_jet1_SF_JEC_down     = (1-ceff(m_btag_workpoint,fill_jet1pt_JEC_down)*c_scale("central",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-ceff(m_btag_workpoint,fill_jet1pt_JEC_down));
                  btag_jet1_up_SF_JEC_down  = (1-ceff(m_btag_workpoint,fill_jet1pt_JEC_down)*c_scale("up",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-ceff(m_btag_workpoint,fill_jet1pt_JEC_down));
                  btag_jet1_low_SF_JEC_down = (1-ceff(m_btag_workpoint,fill_jet1pt_JEC_down)*c_scale("low",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-ceff(m_btag_workpoint,fill_jet1pt_JEC_down));
               }
            }


            if(fabs(fill_jet1pf_JEC_down)!=4 && fabs(fill_jet1pf_JEC_down)!=5){
               if(fill_jet1deepcsv_JEC_down>btag_cut_value){
                  btag_jet1_SF_JEC_down     = l_scale("central",m_btag_workpoint,fill_jet1pt_JEC_down);
                  btag_jet1_up_SF_JEC_down  = l_scale("up",m_btag_workpoint,fill_jet1pt_JEC_down);
                  btag_jet1_low_SF_JEC_down = l_scale("low",m_btag_workpoint,fill_jet1pt_JEC_down);
               }
               if(fill_jet1deepcsv_JEC_down<btag_cut_value){
                  btag_jet1_SF_JEC_down     = (1-leff(m_btag_workpoint,fill_jet1pt_JEC_down)*l_scale("central",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-leff(m_btag_workpoint,fill_jet1pt_JEC_down));
                  btag_jet1_up_SF_JEC_down  = (1-leff(m_btag_workpoint,fill_jet1pt_JEC_down)*l_scale("up",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-leff(m_btag_workpoint,fill_jet1pt_JEC_down));
                  btag_jet1_low_SF_JEC_down = (1-leff(m_btag_workpoint,fill_jet1pt_JEC_down)*l_scale("low",m_btag_workpoint,fill_jet1pt_JEC_down))/(1-leff(m_btag_workpoint,fill_jet1pt_JEC_down));
               }
            }
         }

         else{
            btag_jet1_SF_JEC_down     = 1;
            btag_jet1_up_SF_JEC_down  = 1;
            btag_jet1_low_SF_JEC_down = 1;
         }

         // jet1 : jer_up
         if(fabs(fill_jet1eta_JER_up)<2.5){
            if(fabs(fill_jet1pf_JER_up)==5){
               if(fill_jet1deepcsv_JER_up>btag_cut_value){
                  btag_jet1_SF_JER_up     = b_scale("central",m_btag_workpoint,fill_jet1pt_JER_up);
                  btag_jet1_up_SF_JER_up  = b_scale("up",m_btag_workpoint,fill_jet1pt_JER_up);
                  btag_jet1_low_SF_JER_up = b_scale("low",m_btag_workpoint,fill_jet1pt_JER_up);
               }
               if(fill_jet1deepcsv_JER_up<btag_cut_value){
                  btag_jet1_SF_JER_up     = (1-beff(m_btag_workpoint,fill_jet1pt_JER_up)*b_scale("central",m_btag_workpoint,fill_jet1pt_JER_up))/(1-beff(m_btag_workpoint,fill_jet1pt_JER_up));
                  btag_jet1_up_SF_JER_up  = (1-beff(m_btag_workpoint,fill_jet1pt_JER_up)*b_scale("up",m_btag_workpoint,fill_jet1pt_JER_up))/(1-beff(m_btag_workpoint,fill_jet1pt_JER_up));
                  btag_jet1_low_SF_JER_up = (1-beff(m_btag_workpoint,fill_jet1pt_JER_up)*b_scale("low",m_btag_workpoint,fill_jet1pt_JER_up))/(1-beff(m_btag_workpoint,fill_jet1pt_JER_up));
               }
            }

            if(fabs(fill_jet1pf_JER_up)==4){
               if(fill_jet1deepcsv_JER_up>btag_cut_value){
                  btag_jet1_SF_JER_up     = c_scale("central",m_btag_workpoint,fill_jet1pt_JER_up);
                  btag_jet1_up_SF_JER_up  = c_scale("up",m_btag_workpoint,fill_jet1pt_JER_up);
                  btag_jet1_low_SF_JER_up = c_scale("low",m_btag_workpoint,fill_jet1pt_JER_up);
               }
               if(fill_jet1deepcsv_JER_up<btag_cut_value){
                  btag_jet1_SF_JER_up     = (1-ceff(m_btag_workpoint,fill_jet1pt_JER_up)*c_scale("central",m_btag_workpoint,fill_jet1pt_JER_up))/(1-ceff(m_btag_workpoint,fill_jet1pt_JER_up));
                  btag_jet1_up_SF_JER_up  = (1-ceff(m_btag_workpoint,fill_jet1pt_JER_up)*c_scale("up",m_btag_workpoint,fill_jet1pt_JER_up))/(1-ceff(m_btag_workpoint,fill_jet1pt_JER_up));
                  btag_jet1_low_SF_JER_up = (1-ceff(m_btag_workpoint,fill_jet1pt_JER_up)*c_scale("low",m_btag_workpoint,fill_jet1pt_JER_up))/(1-ceff(m_btag_workpoint,fill_jet1pt_JER_up));
               }
            }


            if(fabs(fill_jet1pf_JER_up)!=4 && fabs(fill_jet1pf_JER_up)!=5){
               if(fill_jet1deepcsv_JER_up>btag_cut_value){
                  btag_jet1_SF_JER_up     = l_scale("central",m_btag_workpoint,fill_jet1pt_JER_up);
                  btag_jet1_up_SF_JER_up  = l_scale("up",m_btag_workpoint,fill_jet1pt_JER_up);
                  btag_jet1_low_SF_JER_up = l_scale("low",m_btag_workpoint,fill_jet1pt_JER_up);
               }
               if(fill_jet1deepcsv_JER_up<btag_cut_value){
                  btag_jet1_SF_JER_up     = (1-leff(m_btag_workpoint,fill_jet1pt_JER_up)*l_scale("central",m_btag_workpoint,fill_jet1pt_JER_up))/(1-leff(m_btag_workpoint,fill_jet1pt_JER_up));
                  btag_jet1_up_SF_JER_up  = (1-leff(m_btag_workpoint,fill_jet1pt_JER_up)*l_scale("up",m_btag_workpoint,fill_jet1pt_JER_up))/(1-leff(m_btag_workpoint,fill_jet1pt_JER_up));
                  btag_jet1_low_SF_JER_up = (1-leff(m_btag_workpoint,fill_jet1pt_JER_up)*l_scale("low",m_btag_workpoint,fill_jet1pt_JER_up))/(1-leff(m_btag_workpoint,fill_jet1pt_JER_up));
               }
            }
         }

         else{
            btag_jet1_SF_JER_up     = 1;
            btag_jet1_up_SF_JER_up  = 1;
            btag_jet1_low_SF_JER_up = 1;
         }

         // jet1 : jer_down
         if(fabs(fill_jet1eta_JER_down)<2.5){
            if(fabs(fill_jet1pf_JER_down)==5){
               if(fill_jet1deepcsv_JER_down>btag_cut_value){
                  btag_jet1_SF_JER_down     = b_scale("central",m_btag_workpoint,fill_jet1pt_JER_down);
                  btag_jet1_up_SF_JER_down  = b_scale("up",m_btag_workpoint,fill_jet1pt_JER_down);
                  btag_jet1_low_SF_JER_down = b_scale("low",m_btag_workpoint,fill_jet1pt_JER_down);
               }
               if(fill_jet1deepcsv_JER_down<btag_cut_value){
                  btag_jet1_SF_JER_down     = (1-beff(m_btag_workpoint,fill_jet1pt_JER_down)*b_scale("central",m_btag_workpoint,fill_jet1pt_JER_down))/(1-beff(m_btag_workpoint,fill_jet1pt_JER_down));
                  btag_jet1_up_SF_JER_down  = (1-beff(m_btag_workpoint,fill_jet1pt_JER_down)*b_scale("up",m_btag_workpoint,fill_jet1pt_JER_down))/(1-beff(m_btag_workpoint,fill_jet1pt_JER_down));
                  btag_jet1_low_SF_JER_down = (1-beff(m_btag_workpoint,fill_jet1pt_JER_down)*b_scale("low",m_btag_workpoint,fill_jet1pt_JER_down))/(1-beff(m_btag_workpoint,fill_jet1pt_JER_down));
               }
            }

            if(fabs(fill_jet1pf_JER_down)==4){
               if(fill_jet1deepcsv_JER_down>btag_cut_value){
                  btag_jet1_SF_JER_down     = c_scale("central",m_btag_workpoint,fill_jet1pt_JER_down);
                  btag_jet1_up_SF_JER_down  = c_scale("up",m_btag_workpoint,fill_jet1pt_JER_down);
                  btag_jet1_low_SF_JER_down = c_scale("low",m_btag_workpoint,fill_jet1pt_JER_down);
               }
               if(fill_jet1deepcsv_JER_down<btag_cut_value){
                  btag_jet1_SF_JER_down     = (1-ceff(m_btag_workpoint,fill_jet1pt_JER_down)*c_scale("central",m_btag_workpoint,fill_jet1pt_JER_down))/(1-ceff(m_btag_workpoint,fill_jet1pt_JER_down));
                  btag_jet1_up_SF_JER_down  = (1-ceff(m_btag_workpoint,fill_jet1pt_JER_down)*c_scale("up",m_btag_workpoint,fill_jet1pt_JER_down))/(1-ceff(m_btag_workpoint,fill_jet1pt_JER_down));
                  btag_jet1_low_SF_JER_down = (1-ceff(m_btag_workpoint,fill_jet1pt_JER_down)*c_scale("low",m_btag_workpoint,fill_jet1pt_JER_down))/(1-ceff(m_btag_workpoint,fill_jet1pt_JER_down));
               }
            }


            if(fabs(fill_jet1pf_JER_down)!=4 && fabs(fill_jet1pf_JER_down)!=5){
               if(fill_jet1deepcsv_JER_down>btag_cut_value){
                  btag_jet1_SF_JER_down     = l_scale("central",m_btag_workpoint,fill_jet1pt_JER_down);
                  btag_jet1_up_SF_JER_down  = l_scale("up",m_btag_workpoint,fill_jet1pt_JER_down);
                  btag_jet1_low_SF_JER_down = l_scale("low",m_btag_workpoint,fill_jet1pt_JER_down);
               }
               if(fill_jet1deepcsv_JER_down<btag_cut_value){
                  btag_jet1_SF_JER_down     = (1-leff(m_btag_workpoint,fill_jet1pt_JER_down)*l_scale("central",m_btag_workpoint,fill_jet1pt_JER_down))/(1-leff(m_btag_workpoint,fill_jet1pt_JER_down));
                  btag_jet1_up_SF_JER_down  = (1-leff(m_btag_workpoint,fill_jet1pt_JER_down)*l_scale("up",m_btag_workpoint,fill_jet1pt_JER_down))/(1-leff(m_btag_workpoint,fill_jet1pt_JER_down));
                  btag_jet1_low_SF_JER_down = (1-leff(m_btag_workpoint,fill_jet1pt_JER_down)*l_scale("low",m_btag_workpoint,fill_jet1pt_JER_down))/(1-leff(m_btag_workpoint,fill_jet1pt_JER_down));
               }
            }
         }

         else{
            btag_jet1_SF_JER_down     = 1;
            btag_jet1_up_SF_JER_down  = 1;
            btag_jet1_low_SF_JER_down = 1;
         }
         ...
         // jet2 : jec_up
         if(fabs(fill_jet2eta_JEC_up)<2.5){
            if(fabs(fill_jet2pf_JEC_up)==5){
               if(fill_jet2deepcsv_JEC_up>btag_cut_value){
                  btag_jet2_SF_JEC_up     = b_scale("central",m_btag_workpoint,fill_jet2pt_JEC_up);
                  btag_jet2_up_SF_JEC_up  = b_scale("up",m_btag_workpoint,fill_jet2pt_JEC_up);
                  btag_jet2_low_SF_JEC_up = b_scale("low",m_btag_workpoint,fill_jet2pt_JEC_up);
               }
               if(fill_jet2deepcsv_JEC_up<btag_cut_value){
                  btag_jet2_SF_JEC_up     = (1-beff(m_btag_workpoint,fill_jet2pt_JEC_up)*b_scale("central",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-beff(m_btag_workpoint,fill_jet2pt_JEC_up));
                  btag_jet2_up_SF_JEC_up  = (1-beff(m_btag_workpoint,fill_jet2pt_JEC_up)*b_scale("up",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-beff(m_btag_workpoint,fill_jet2pt_JEC_up));
                  btag_jet2_low_SF_JEC_up = (1-beff(m_btag_workpoint,fill_jet2pt_JEC_up)*b_scale("low",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-beff(m_btag_workpoint,fill_jet2pt_JEC_up));
               }
            }

            if(fabs(fill_jet2pf_JEC_up)==4){
               if(fill_jet2deepcsv_JEC_up>btag_cut_value){
                  btag_jet2_SF_JEC_up     = c_scale("central",m_btag_workpoint,fill_jet2pt_JEC_up);
                  btag_jet2_up_SF_JEC_up  = c_scale("up",m_btag_workpoint,fill_jet2pt_JEC_up);
                  btag_jet2_low_SF_JEC_up = c_scale("low",m_btag_workpoint,fill_jet2pt_JEC_up);
               }
               if(fill_jet2deepcsv_JEC_up<btag_cut_value){
                  btag_jet2_SF_JEC_up     = (1-ceff(m_btag_workpoint,fill_jet2pt_JEC_up)*c_scale("central",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-ceff(m_btag_workpoint,fill_jet2pt_JEC_up));
                  btag_jet2_up_SF_JEC_up  = (1-ceff(m_btag_workpoint,fill_jet2pt_JEC_up)*c_scale("up",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-ceff(m_btag_workpoint,fill_jet2pt_JEC_up));
                  btag_jet2_low_SF_JEC_up = (1-ceff(m_btag_workpoint,fill_jet2pt_JEC_up)*c_scale("low",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-ceff(m_btag_workpoint,fill_jet2pt_JEC_up));
               }
            }

            if(fabs(fill_jet2pf_JEC_up)!=4 && fabs(fill_jet2pf_JEC_up)!=5){
               if(fill_jet2deepcsv_JEC_up>btag_cut_value){
                  btag_jet2_SF_JEC_up     = l_scale("central",m_btag_workpoint,fill_jet2pt_JEC_up);
                  btag_jet2_up_SF_JEC_up  = l_scale("up",m_btag_workpoint,fill_jet2pt_JEC_up);
                  btag_jet2_low_SF_JEC_up = l_scale("low",m_btag_workpoint,fill_jet2pt_JEC_up);
               }
               if(fill_jet2deepcsv_JEC_up<btag_cut_value){
                  btag_jet2_SF_JEC_up     = (1-leff(m_btag_workpoint,fill_jet2pt_JEC_up)*l_scale("central",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-leff(m_btag_workpoint,fill_jet2pt_JEC_up));
                  btag_jet2_up_SF_JEC_up  = (1-leff(m_btag_workpoint,fill_jet2pt_JEC_up)*l_scale("up",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-leff(m_btag_workpoint,fill_jet2pt_JEC_up));
                  btag_jet2_low_SF_JEC_up = (1-leff(m_btag_workpoint,fill_jet2pt_JEC_up)*l_scale("low",m_btag_workpoint,fill_jet2pt_JEC_up))/(1-leff(m_btag_workpoint,fill_jet2pt_JEC_up));
               }
            }
         }

         else{
            btag_jet2_SF_JEC_up     = 1;
            btag_jet2_up_SF_JEC_up  = 1;
            btag_jet2_low_SF_JEC_up = 1;
         }

         // jet2 : jec_down
         if(fabs(fill_jet2eta_JEC_down)<2.5){
            if(fabs(fill_jet2pf_JEC_down)==5){
               if(fill_jet2deepcsv_JEC_down>btag_cut_value){
                  btag_jet2_SF_JEC_down     = b_scale("central",m_btag_workpoint,fill_jet2pt_JEC_down);
                  btag_jet2_up_SF_JEC_down  = b_scale("up",m_btag_workpoint,fill_jet2pt_JEC_down);
                  btag_jet2_low_SF_JEC_down = b_scale("low",m_btag_workpoint,fill_jet2pt_JEC_down);
               }
               if(fill_jet2deepcsv_JEC_down<btag_cut_value){
                  btag_jet2_SF_JEC_down     = (1-beff(m_btag_workpoint,fill_jet2pt_JEC_down)*b_scale("central",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-beff(m_btag_workpoint,fill_jet2pt_JEC_down));
                  btag_jet2_up_SF_JEC_down  = (1-beff(m_btag_workpoint,fill_jet2pt_JEC_down)*b_scale("up",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-beff(m_btag_workpoint,fill_jet2pt_JEC_down));
                  btag_jet2_low_SF_JEC_down = (1-beff(m_btag_workpoint,fill_jet2pt_JEC_down)*b_scale("low",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-beff(m_btag_workpoint,fill_jet2pt_JEC_down));
               }
            }

            if(fabs(fill_jet2pf_JEC_down)==4){
               if(fill_jet2deepcsv_JEC_down>btag_cut_value){
                  btag_jet2_SF_JEC_down     = c_scale("central",m_btag_workpoint,fill_jet2pt_JEC_down);
                  btag_jet2_up_SF_JEC_down  = c_scale("up",m_btag_workpoint,fill_jet2pt_JEC_down);
                  btag_jet2_low_SF_JEC_down = c_scale("low",m_btag_workpoint,fill_jet2pt_JEC_down);
               }
               if(fill_jet2deepcsv_JEC_down<btag_cut_value){
                  btag_jet2_SF_JEC_down     = (1-ceff(m_btag_workpoint,fill_jet2pt_JEC_down)*c_scale("central",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-ceff(m_btag_workpoint,fill_jet2pt_JEC_down));
                  btag_jet2_up_SF_JEC_down  = (1-ceff(m_btag_workpoint,fill_jet2pt_JEC_down)*c_scale("up",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-ceff(m_btag_workpoint,fill_jet2pt_JEC_down));
                  btag_jet2_low_SF_JEC_down = (1-ceff(m_btag_workpoint,fill_jet2pt_JEC_down)*c_scale("low",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-ceff(m_btag_workpoint,fill_jet2pt_JEC_down));
               }
            }


            if(fabs(fill_jet2pf_JEC_down)!=4 && fabs(fill_jet2pf_JEC_down)!=5){
               if(fill_jet2deepcsv_JEC_down>btag_cut_value){
                  btag_jet2_SF_JEC_down     = l_scale("central",m_btag_workpoint,fill_jet2pt_JEC_down);
                  btag_jet2_up_SF_JEC_down  = l_scale("up",m_btag_workpoint,fill_jet2pt_JEC_down);
                  btag_jet2_low_SF_JEC_down = l_scale("low",m_btag_workpoint,fill_jet2pt_JEC_down);
               }
               if(fill_jet2deepcsv_JEC_down<btag_cut_value){
                  btag_jet2_SF_JEC_down     = (1-leff(m_btag_workpoint,fill_jet2pt_JEC_down)*l_scale("central",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-leff(m_btag_workpoint,fill_jet2pt_JEC_down));
                  btag_jet2_up_SF_JEC_down  = (1-leff(m_btag_workpoint,fill_jet2pt_JEC_down)*l_scale("up",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-leff(m_btag_workpoint,fill_jet2pt_JEC_down));
                  btag_jet2_low_SF_JEC_down = (1-leff(m_btag_workpoint,fill_jet2pt_JEC_down)*l_scale("low",m_btag_workpoint,fill_jet2pt_JEC_down))/(1-leff(m_btag_workpoint,fill_jet2pt_JEC_down));
               }
            }
         }

         else{
            btag_jet2_SF_JEC_down     = 1;
            btag_jet2_up_SF_JEC_down  = 1;
            btag_jet2_low_SF_JEC_down = 1;
         }

         // jet2 : jer_up
         if(fabs(fill_jet2eta_JER_up)<2.5){
            if(fabs(fill_jet2pf_JER_up)==5){
               if(fill_jet2deepcsv_JER_up>btag_cut_value){
                  btag_jet2_SF_JER_up     = b_scale("central",m_btag_workpoint,fill_jet2pt_JER_up);
                  btag_jet2_up_SF_JER_up  = b_scale("up",m_btag_workpoint,fill_jet2pt_JER_up);
                  btag_jet2_low_SF_JER_up = b_scale("low",m_btag_workpoint,fill_jet2pt_JER_up);
               }
               if(fill_jet2deepcsv_JER_up<btag_cut_value){
                  btag_jet2_SF_JER_up     = (1-beff(m_btag_workpoint,fill_jet2pt_JER_up)*b_scale("central",m_btag_workpoint,fill_jet2pt_JER_up))/(1-beff(m_btag_workpoint,fill_jet2pt_JER_up));
                  btag_jet2_up_SF_JER_up  = (1-beff(m_btag_workpoint,fill_jet2pt_JER_up)*b_scale("up",m_btag_workpoint,fill_jet2pt_JER_up))/(1-beff(m_btag_workpoint,fill_jet2pt_JER_up));
                  btag_jet2_low_SF_JER_up = (1-beff(m_btag_workpoint,fill_jet2pt_JER_up)*b_scale("low",m_btag_workpoint,fill_jet2pt_JER_up))/(1-beff(m_btag_workpoint,fill_jet2pt_JER_up));
               }
            }

            if(fabs(fill_jet2pf_JER_up)==4){
               if(fill_jet2deepcsv_JER_up>btag_cut_value){
                  btag_jet2_SF_JER_up     = c_scale("central",m_btag_workpoint,fill_jet2pt_JER_up);
                  btag_jet2_up_SF_JER_up  = c_scale("up",m_btag_workpoint,fill_jet2pt_JER_up);
                  btag_jet2_low_SF_JER_up = c_scale("low",m_btag_workpoint,fill_jet2pt_JER_up);
               }
               if(fill_jet2deepcsv_JER_up<btag_cut_value){
                  btag_jet2_SF_JER_up     = (1-ceff(m_btag_workpoint,fill_jet2pt_JER_up)*c_scale("central",m_btag_workpoint,fill_jet2pt_JER_up))/(1-ceff(m_btag_workpoint,fill_jet2pt_JER_up));
                  btag_jet2_up_SF_JER_up  = (1-ceff(m_btag_workpoint,fill_jet2pt_JER_up)*c_scale("up",m_btag_workpoint,fill_jet2pt_JER_up))/(1-ceff(m_btag_workpoint,fill_jet2pt_JER_up));
                  btag_jet2_low_SF_JER_up = (1-ceff(m_btag_workpoint,fill_jet2pt_JER_up)*c_scale("low",m_btag_workpoint,fill_jet2pt_JER_up))/(1-ceff(m_btag_workpoint,fill_jet2pt_JER_up));
               }
            }


            if(fabs(fill_jet2pf_JER_up)!=4 && fabs(fill_jet2pf_JER_up)!=5){
               if(fill_jet2deepcsv_JER_up>btag_cut_value){
                  btag_jet2_SF_JER_up     = l_scale("central",m_btag_workpoint,fill_jet2pt_JER_up);
                  btag_jet2_up_SF_JER_up  = l_scale("up",m_btag_workpoint,fill_jet2pt_JER_up);
                  btag_jet2_low_SF_JER_up = l_scale("low",m_btag_workpoint,fill_jet2pt_JER_up);
               }
               if(fill_jet2deepcsv_JER_up<btag_cut_value){
                  btag_jet2_SF_JER_up     = (1-leff(m_btag_workpoint,fill_jet2pt_JER_up)*l_scale("central",m_btag_workpoint,fill_jet2pt_JER_up))/(1-leff(m_btag_workpoint,fill_jet2pt_JER_up));
                  btag_jet2_up_SF_JER_up  = (1-leff(m_btag_workpoint,fill_jet2pt_JER_up)*l_scale("up",m_btag_workpoint,fill_jet2pt_JER_up))/(1-leff(m_btag_workpoint,fill_jet2pt_JER_up));
                  btag_jet2_low_SF_JER_up = (1-leff(m_btag_workpoint,fill_jet2pt_JER_up)*l_scale("low",m_btag_workpoint,fill_jet2pt_JER_up))/(1-leff(m_btag_workpoint,fill_jet2pt_JER_up));
               }
            }
         }

         else{
            btag_jet2_SF_JER_up     = 1;
            btag_jet2_up_SF_JER_up  = 1;
            btag_jet2_low_SF_JER_up = 1;
         }

         // jet2 : jer_down
         if(fabs(fill_jet2eta_JER_down)<2.5){
            if(fabs(fill_jet2pf_JER_down)==5){
               if(fill_jet2deepcsv_JER_down>btag_cut_value){
                  btag_jet2_SF_JER_down     = b_scale("central",m_btag_workpoint,fill_jet2pt_JER_down);
                  btag_jet2_up_SF_JER_down  = b_scale("up",m_btag_workpoint,fill_jet2pt_JER_down);
                  btag_jet2_low_SF_JER_down = b_scale("low",m_btag_workpoint,fill_jet2pt_JER_down);
               }
               if(fill_jet2deepcsv_JER_down<btag_cut_value){
                  btag_jet2_SF_JER_down     = (1-beff(m_btag_workpoint,fill_jet2pt_JER_down)*b_scale("central",m_btag_workpoint,fill_jet2pt_JER_down))/(1-beff(m_btag_workpoint,fill_jet2pt_JER_down));
                  btag_jet2_up_SF_JER_down  = (1-beff(m_btag_workpoint,fill_jet2pt_JER_down)*b_scale("up",m_btag_workpoint,fill_jet2pt_JER_down))/(1-beff(m_btag_workpoint,fill_jet2pt_JER_down));
                  btag_jet2_low_SF_JER_down = (1-beff(m_btag_workpoint,fill_jet2pt_JER_down)*b_scale("low",m_btag_workpoint,fill_jet2pt_JER_down))/(1-beff(m_btag_workpoint,fill_jet2pt_JER_down));
               }
            }

            if(fabs(fill_jet2pf_JER_down)==4){
               if(fill_jet2deepcsv_JER_down>btag_cut_value){
                  btag_jet2_SF_JER_down     = c_scale("central",m_btag_workpoint,fill_jet2pt_JER_down);
                  btag_jet2_up_SF_JER_down  = c_scale("up",m_btag_workpoint,fill_jet2pt_JER_down);
                  btag_jet2_low_SF_JER_down = c_scale("low",m_btag_workpoint,fill_jet2pt_JER_down);
               }
               if(fill_jet2deepcsv_JER_down<btag_cut_value){
                  btag_jet2_SF_JER_down     = (1-ceff(m_btag_workpoint,fill_jet2pt_JER_down)*c_scale("central",m_btag_workpoint,fill_jet2pt_JER_down))/(1-ceff(m_btag_workpoint,fill_jet2pt_JER_down));
                  btag_jet2_up_SF_JER_down  = (1-ceff(m_btag_workpoint,fill_jet2pt_JER_down)*c_scale("up",m_btag_workpoint,fill_jet2pt_JER_down))/(1-ceff(m_btag_workpoint,fill_jet2pt_JER_down));
                  btag_jet2_low_SF_JER_down = (1-ceff(m_btag_workpoint,fill_jet2pt_JER_down)*c_scale("low",m_btag_workpoint,fill_jet2pt_JER_down))/(1-ceff(m_btag_workpoint,fill_jet2pt_JER_down));
               }
            }


            if(fabs(fill_jet2pf_JER_down)!=4 && fabs(fill_jet2pf_JER_down)!=5){
               if(fill_jet2deepcsv_JER_down>btag_cut_value){
                  btag_jet2_SF_JER_down     = l_scale("central",m_btag_workpoint,fill_jet2pt_JER_down);
                  btag_jet2_up_SF_JER_down  = l_scale("up",m_btag_workpoint,fill_jet2pt_JER_down);
                  btag_jet2_low_SF_JER_down = l_scale("low",m_btag_workpoint,fill_jet2pt_JER_down);
               }
               if(fill_jet2deepcsv_JER_down<btag_cut_value){
                  btag_jet2_SF_JER_down     = (1-leff(m_btag_workpoint,fill_jet2pt_JER_down)*l_scale("central",m_btag_workpoint,fill_jet2pt_JER_down))/(1-leff(m_btag_workpoint,fill_jet2pt_JER_down));
                  btag_jet2_up_SF_JER_down  = (1-leff(m_btag_workpoint,fill_jet2pt_JER_down)*l_scale("up",m_btag_workpoint,fill_jet2pt_JER_down))/(1-leff(m_btag_workpoint,fill_jet2pt_JER_down));
                  btag_jet2_low_SF_JER_down = (1-leff(m_btag_workpoint,fill_jet2pt_JER_down)*l_scale("low",m_btag_workpoint,fill_jet2pt_JER_down))/(1-leff(m_btag_workpoint,fill_jet2pt_JER_down));
               }
            }
         }

         else{
            btag_jet2_SF_JER_down     = 1;
            btag_jet2_up_SF_JER_down  = 1;
            btag_jet2_low_SF_JER_down = 1;
         }
      ...
      double weight = 1, weight_jec_up = 1, weight_jec_down = 1, weight_jer_up = 1, weight_jer_down = 1;
...
//cout<<fill_Mva<<fill_Mva_JEC_up<<endl;
      ...
      if (fabs(fill_photonsceta) < 1.4442){
         if(m_type == "data") { 
            ...
            weight_electron_up = 1; 
            weight_electron_down = 1;
            weight_muon_ID_up = 1;
            ...
            weight_electron_up = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_up_SF * electron_Reco_up_SF * electron_HLT_up_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            weight_electron_down = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_low_SF * electron_Reco_low_SF * electron_HLT_low_SF *muon_ID_SF * muon_iso_SF * muon_HLT_SF*btag_jet1_SF * btag_jet2_SF;
            ...
            weight_muon_up = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_up_SF * muon_iso_up_SF * muon_HLT_up_SF * btag_jet1_SF * btag_jet2_SF;
            weight_muon_down = cross_section_SF * pu_weight_SF * photon_ID_SF * electron_ID_SF * electron_Reco_SF * electron_HLT_SF *muon_ID_low_SF * muon_iso_low_SF * muon_HLT_low_SF * btag_jet1_SF * btag_jet2_SF;
         ...
         if (m_region == "aqgc") {
            if (cut1) {
               hist_WGmass_barrel_center->Fill(fill_Mva,weight);
               hist_WGmass_center->Fill(fill_Mva,weight);
               if(m_sample == "WGJJ" || m_sample == "WGJets"){
                  for(Int_t iw=0;iw<400;iw++){
                     //actualWeight[iw]=weight*pweight[iw+225];
                     th2[iw]->Fill(fill_Mva, weight*pweight[iw+225]);
                     th2_barrel[iw]->Fill(fill_Mva, weight*pweight[iw+225]);
                  }
               }

               hist_WGmass_barrel_photon_ID_up->Fill(fill_Mva,weight_photon_ID_up);
               hist_WGmass_barrel_photon_ID_down->Fill(fill_Mva,weight_photon_ID_down);

               hist_WGmass_barrel_electron_ID_up->Fill(fill_Mva,weight_electron_ID_up);
               hist_WGmass_barrel_electron_ID_down->Fill(fill_Mva,weight_electron_ID_down);

               hist_WGmass_barrel_electron_Reco_up->Fill(fill_Mva,weight_electron_Reco_up);
               hist_WGmass_barrel_electron_Reco_down->Fill(fill_Mva,weight_electron_Reco_down);

               hist_WGmass_barrel_electron_HLT_up->Fill(fill_Mva,weight_electron_HLT_up);
               hist_WGmass_barrel_electron_HLT_down->Fill(fill_Mva,weight_electron_HLT_down);

               hist_WGmass_barrel_muon_ID_up->Fill(fill_Mva,weight_muon_ID_up);
               hist_WGmass_barrel_muon_ID_down->Fill(fill_Mva,weight_muon_ID_down);

               hist_WGmass_barrel_muon_iso_up->Fill(fill_Mva,weight_muon_iso_up);
               hist_WGmass_barrel_muon_iso_down->Fill(fill_Mva,weight_muon_iso_down);

               hist_WGmass_barrel_muon_HLT_up->Fill(fill_Mva,weight_muon_HLT_up);
               hist_WGmass_barrel_muon_HLT_down->Fill(fill_Mva,weight_muon_HLT_down);

               hist_WGmass_photon_ID_up->Fill(fill_Mva,weight_photon_ID_up);
               hist_WGmass_photon_ID_down->Fill(fill_Mva,weight_photon_ID_down);

               hist_WGmass_electron_ID_up->Fill(fill_Mva,weight_electron_ID_up);
               hist_WGmass_electron_ID_down->Fill(fill_Mva,weight_electron_ID_down);

               hist_WGmass_electron_Reco_up->Fill(fill_Mva,weight_electron_Reco_up);
               hist_WGmass_electron_Reco_down->Fill(fill_Mva,weight_electron_Reco_down);

               hist_WGmass_electron_HLT_up->Fill(fill_Mva,weight_electron_HLT_up);
               hist_WGmass_electron_HLT_down->Fill(fill_Mva,weight_electron_HLT_down);

               hist_WGmass_muon_ID_up->Fill(fill_Mva,weight_muon_ID_up);
               hist_WGmass_muon_ID_down->Fill(fill_Mva,weight_muon_ID_down);

               hist_WGmass_muon_iso_up->Fill(fill_Mva,weight_muon_iso_up);
               hist_WGmass_muon_iso_down->Fill(fill_Mva,weight_muon_iso_down);

               hist_WGmass_muon_HLT_up->Fill(fill_Mva,weight_muon_HLT_up);
               hist_WGmass_muon_HLT_down->Fill(fill_Mva,weight_muon_HLT_down);

               hist_WGmass_barrel_muon_up->Fill(fill_Mva,weight_muon_up);
               hist_WGmass_barrel_muon_down->Fill(fill_Mva,weight_muon_down);
               hist_WGmass_barrel_electron_up->Fill(fill_Mva,weight_electron_up);
               hist_WGmass_barrel_electron_down->Fill(fill_Mva,weight_electron_down);

               hist_WGmass_electron_up->Fill(fill_Mva,weight_electron_up);
               hist_WGmass_electron_down->Fill(fill_Mva,weight_electron_down);
               hist_WGmass_muon_up->Fill(fill_Mva,weight_muon_up);
               hist_WGmass_muon_down->Fill(fill_Mva,weight_muon_down);


            }
            if (cut2) {
               hist_WGmass_barrel_jec_up->Fill(fill_Mva_JEC_up,weight_jec_up);
               hist_WGmass_jec_up->Fill(fill_Mva_JEC_up,weight_jec_up);
            }
            if (cut3) {
               hist_WGmass_barrel_jec_down->Fill(fill_Mva_JEC_down,weight_jec_down);
               hist_WGmass_jec_down->Fill(fill_Mva_JEC_down,weight_jec_down);
            }
            if (cut4) {
               hist_WGmass_barrel_jer_up->Fill(fill_Mva_JER_up,weight_jer_up);
               hist_WGmass_jer_up->Fill(fill_Mva_JER_up,weight_jer_up);
            }
            if (cut5) {
               hist_WGmass_barrel_jer_down->Fill(fill_Mva_JER_down,weight_jer_down);
               hist_WGmass_jer_down->Fill(fill_Mva_JER_down,weight_jer_down);
            }
      ...
      if (fabs(fill_photonsceta) > 1.566 && fabs(fill_photonsceta) < 2.5){
         ...
         if (m_region == "aqgc") {
            if (cut1) {
               hist_WGmass_endcap_center->Fill(fill_Mva,weight);
               hist_WGmass_center->Fill(fill_Mva,weight);
               if(m_sample == "WGJJ" || m_sample == "WGJets"){
                  for(Int_t iw=0;iw<400;iw++){
     	             //actualWeight[iw]=weight*pweight[iw+225];
	                 th2[iw]->Fill(fill_Mva, weight*pweight[iw+225]);
                     th2_endcap[iw]->Fill(fill_Mva, weight*pweight[iw+225]);
                  } 
               }

               hist_WGmass_endcap_photon_ID_up->Fill(fill_Mva,weight_photon_ID_up);
               hist_WGmass_endcap_photon_ID_down->Fill(fill_Mva,weight_photon_ID_down);

               hist_WGmass_endcap_electron_ID_up->Fill(fill_Mva,weight_electron_ID_up);
               hist_WGmass_endcap_electron_ID_down->Fill(fill_Mva,weight_electron_ID_down);

               hist_WGmass_endcap_electron_Reco_up->Fill(fill_Mva,weight_electron_Reco_up);
               hist_WGmass_endcap_electron_Reco_down->Fill(fill_Mva,weight_electron_Reco_down);

               hist_WGmass_endcap_electron_HLT_up->Fill(fill_Mva,weight_electron_HLT_up);
               hist_WGmass_endcap_electron_HLT_down->Fill(fill_Mva,weight_electron_HLT_down);

               hist_WGmass_endcap_muon_ID_up->Fill(fill_Mva,weight_muon_ID_up);
               hist_WGmass_endcap_muon_ID_down->Fill(fill_Mva,weight_muon_ID_down);

               hist_WGmass_endcap_muon_iso_up->Fill(fill_Mva,weight_muon_iso_up);
               hist_WGmass_endcap_muon_iso_down->Fill(fill_Mva,weight_muon_iso_down);

               hist_WGmass_endcap_muon_HLT_up->Fill(fill_Mva,weight_muon_HLT_up);
               hist_WGmass_endcap_muon_HLT_down->Fill(fill_Mva,weight_muon_HLT_down);
               ...
               hist_WGmass_endcap_muon_up->Fill(fill_Mva,weight_muon_up);
               hist_WGmass_endcap_muon_down->Fill(fill_Mva,weight_muon_down);
               hist_WGmass_endcap_electron_up->Fill(fill_Mva,weight_electron_up);
               hist_WGmass_endcap_electron_down->Fill(fill_Mva,weight_electron_down);
            ...
            if (cut2) {
               hist_WGmass_endcap_jec_up->Fill(fill_Mva_JEC_up,weight_jec_up);
               hist_WGmass_jec_up->Fill(fill_Mva_JEC_up,weight_jec_up);
            }
            if (cut3) {
               hist_WGmass_endcap_jec_down->Fill(fill_Mva_JEC_down,weight_jec_down);
               hist_WGmass_jec_down->Fill(fill_Mva_JEC_down,weight_jec_down);
            }
            if (cut4) {
               hist_WGmass_endcap_jer_up->Fill(fill_Mva_JER_up,weight_jer_up);
               hist_WGmass_jer_up->Fill(fill_Mva_JER_up,weight_jer_up);
            }
            if (cut5) {
               hist_WGmass_endcap_jer_down->Fill(fill_Mva_JER_down,weight_jer_down);
               hist_WGmass_jer_down->Fill(fill_Mva_JER_down,weight_jer_down);
            }
