...
TH1D * hist_Mjj_detajj = new TH2D("hist_Mjj_detajj","hist_Mjj_detajj", 6, {0,1,2,3,4,5,6});
...
TH2D * hist_gen_ptlep = new TH1D("hist_gen_ptlep","hist_gen_ptlep", 2, ptlepBins,2, ptlepBins);
TH2D * hist_gen_photonEt = new TH1D("hist_gen_photonEt","hist_gen_photonEt", 2, photonEtBins,2, photonEtBins);
TH2D * hist_gen_jet1pt = new TH1D("hist_gen_jet1pt","hist_gen_jet1pt", 2, jetptBins, 2, jetptBins);
TH2D * hist_gen_Mva = new TH1D("hist_gen_Mva","hist_gen_Mva", 2, MvaBins,2, MvaBins);
TH2D * hist_gen_Mjj_detajj = new TH2D("hist_gen_Mjj_detajj","hist_gen_Mjj_detajj", 6, {0,1,2,3,4,5,6}, 6, {0,1,2,3,4,5,6});

TH2D * hist_gen_Mjj_Signal = new TH1D("hist_gen_Mjj_Signal","hist_gen_Mjj_Signal", 2, Mjj_Signal_Bins,2, Mjj_Signal_Bins);
TH2D * hist_gen_Mjj_Control = new TH1D("hist_gen_Mjj_Control","hist_gen_Mjj_Control", 2, Mjj_Control_Bins,2, Mjj_Control_Bins);

TH2D * hist_outgen_ptlep = new TH1D("hist_outgen_ptlep","hist_outgen_ptlep", 2, ptlepBins,2, ptlepBins);
TH2D * hist_outgen_photonEt = new TH1D("hist_outgen_photonEt","hist_outgen_photonEt", 2, photonEtBins,2, photonEtBins);
TH2D * hist_outgen_jet1pt = new TH1D("hist_outgen_jet1pt","hist_outgen_jet1pt", 2, jetptBins,2, jetptBins);
TH2D * hist_outgen_Mva = new TH1D("hist_outgen_Mva","hist_outgen_Mva", 2, MvaBins,2, MvaBins);
TH2D * hist_outgen_Mjj_detajj = new TH2D("hist_outgen_Mjj_detajj","hist_outgen_Mjj_detajj", 6, {0,1,2,3,4,5,6}, 6, {0,1,2,3,4,5,6});

TH2D * hist_outgen_Mjj_Signal = new TH1D("hist_outgen_Mjj_Signal","hist_outgen_Mjj_Signal", 2, Mjj_Signal_Bins,2, Mjj_Signal_Bins);
TH2D * hist_outgen_Mjj_Control = new TH1D("hist_outgen_Mjj_Control","hist_outgen_Mjj_Control", 2, Mjj_Control_Bins,2, Mjj_Control_Bins);
