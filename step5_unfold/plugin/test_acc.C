...
double acc_genlep1pt = genlep1pt;
double acc_genphotonet = genphotonet;
double acc_genjet1pt = genjet1pt;
double acc_genMla = genMla;
...
if (acc_genlep1pt > 400 ) acc_genlep1pt = 390;
if (acc_genphotonet > 100) acc_genphotonet = 90;
if (acc_genjet1pt > 500) acc_genjet1pt = 450;
if (acc_genMla > 1000) acc_genMla = 900;

if(cut_gen){


   acc_ptlep->Fill(acc_genlep1pt, weight);
   acc_photonet->Fill(acc_genphotonet, weight);
   acc_jet1pt->Fill(acc_genjet1pt, weight);
   acc_mla->Fill(acc_genMla, weight);
