...
cp 1_uncertainty.sh 1_uncertainty_$1.sh
sed -i "s/make_hist/make_hist_$1/g" 1_uncertainty_$1.sh
submit_condor.py unfold 1_uncertainty_$1.sh test_1 unfold_$1_$2
