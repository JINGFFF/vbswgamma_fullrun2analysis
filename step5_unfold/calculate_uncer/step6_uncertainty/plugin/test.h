...
public :
   ...
   void hist_Sumw2();
   void hist_Scale();
   void fill_hist(double fill_ptlep1, vector<double> Bins, TH1D* hist, double weight);
   void fill_gen_hist(double fill_ptlep1, double gen_ptlep1, vector<double> Bins, TH2D* hist, double weight);
