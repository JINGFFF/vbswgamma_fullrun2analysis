...
photonp42.Delete();
      ...
      bool test_cut = pass_signal_region_cuts("muon", fill_HLT_muon, fill_lep, fill_ptlep1, fill_etalep1, fill_ngoodmus, fill_ngoodeles, 
                      fill_nloosemus, fill_nlooseeles, fill_photonhaspixelseed, fill_photonet, fill_jet1pt, fill_jet1eta, 
                      fill_jet2pt,fill_jet2eta, fill_MET_et, fill_mtVlepJECnew, 
                      fill_drla, fill_drj1l, fill_drj2l, fill_drj1a, fill_drj2a, fill_j1metPhi, fill_j2metPhi, fill_jet1deepcsv, fill_jet2deepcsv, 
                      fill_Mjj, fill_Mva, fill_deltaeta, fill_Dphiwajj, fill_zepp, btag_cut_value);
cout<<muon_cut_signal_region<<"   "<<test_cut<<endl;
