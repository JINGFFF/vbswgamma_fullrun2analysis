...
void test::creat_hist(){
   ...
   h_count= new TH1D("hist_count","hist_count", BINS_size, 0, BINS_size);
   h_count_total= new TH1D("hist_count_total","hist_count_total", BINS_size, 0, BINS_size);
...
void test::hist_Scale()
{
   if(m_type == "mc"){
         ...
         h_count->Scale(1/(p_event - n_event));
         h_count_total->Scale(1/(p_event - n_event));
...
fill_hist(genlep1pt, Bins, h_count_total, 1);
if(cut_gen) fill_hist(genlep1pt, Bins, h_count, 1);
...
//if(cut_gen) fill_hist(genlep1pt, Bins, h_count, weight);
