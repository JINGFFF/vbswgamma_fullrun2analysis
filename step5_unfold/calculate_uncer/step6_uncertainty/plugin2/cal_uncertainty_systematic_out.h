...
TH1D * get_systematic_jecr_out_1D(TString which_region, TString outdir, TString which_sample, TString uncertainty_hist_name, TString infilename, TString var_name, double lumi ){
cout<<"ok0"<<endl;
   TFile*input = new TFile (infilename);
cout<<"ok0"<<endl;
   TH1D * h_center   = (TH1D*)input->Get("hist_out_");
   TH1D * h_up       = (TH1D*)input->Get("hist_out_"+uncertainty_hist_name+"_up");
   TH1D * h_down     = (TH1D*)input->Get("hist_out_"+uncertainty_hist_name+"_down");
   h_center->Scale(lumi);
cout<<"ok1"<<endl;
h_center->Print("all");
cout<<"ok1"<<endl;
...
TH1D * get_systematic_uncertainty_out_1D(TString which_region, TString outdir, TString which_sample, TString uncertainty_hist_name, TString infilename, TString var_name, double lumi){
